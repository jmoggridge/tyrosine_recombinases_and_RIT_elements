...
I obtained a number of sequences that are (almost certainly) not tyrosine recombinases by searching RefSeq for specific protein names.
...
Write non-integrases to fasta for HMM scoring later
```{r}
...
# write to `./data/all_non_integrase.fa`
