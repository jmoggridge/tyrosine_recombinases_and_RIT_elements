...
## Check annotations of full proteins from SMART subfamilies
...
```
cd ./data/SMART
hmmscan -o smart.scan.raw --tblout smart.scan.tbl --domtblout smart.scan.domtbl --pfamtblout smart.scan.pftblout subfamilies.hmm full_protein_fasta/Arch1_proteins.fasta
```
