...
rm(cdd_titles, count_table, id_data, nucs_by_taxid, nuc_summary, tot, two_integrases)
...
fetch_gb_set <- function(df, id_var, start, stop, folder){
  ...
  print(glue('{folder}/GB_w_parts_{start}_{stop}.rds'))
